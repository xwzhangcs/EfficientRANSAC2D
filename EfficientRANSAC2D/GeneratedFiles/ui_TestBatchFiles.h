...
public:
    ...
    void retranslateUi(QDialog *TestBatchFiles)
    {
        ...
        label_23->setText(QApplication::translate("TestBatchFiles", "IOU threshold:", Q_NULLPTR));
        label_24->setText(QApplication::translate("TestBatchFiles", "[%]", Q_NULLPTR));
        checkBoxSymmetryLine->setText(QApplication::translate("TestBatchFiles", "Use symmetry line", Q_NULLPTR));
        checkBoxParallel->setText(QApplication::translate("TestBatchFiles", "Use parallelism:", Q_NULLPTR));
        label_25->setText(QApplication::translate("TestBatchFiles", "RA angle threshold:", Q_NULLPTR));
        label_26->setText(QApplication::translate("TestBatchFiles", "[deg]", Q_NULLPTR));
